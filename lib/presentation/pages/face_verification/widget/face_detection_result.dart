...
class _FaceDetectionResultState extends State<FaceDetectionResult> {
  ...
  getFeature() async {
    ...
    String savedList = AuthRepository.getSavedToken()!;
    List savedFeature = json.decode(savedList);
    print("feature 1 ${feature.length}, saved feature ${feature.length}");
    double distance = FaceDetectorService.euclideanDistance(feature, savedFeature);
    setState(() {
